...
import com.example.kzha6954.mysteps.Group.GroupMemberActivity;
...
public class GoogleFitActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.a_a_test);
    ...
    private void handleConnectButton() {
        try {
            authInProgress = true;
            mFitResultResolution.startResolutionForResult(GoogleFitActivity.this, REQUEST_OAUTH);
    ...
    private BroadcastReceiver mFitDataReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (intent.hasExtra(GoogleFitService.HISTORY_EXTRA_STEPS_TODAY)) {
                ...
                Toast.makeText(GoogleFitActivity.this, "Total Steps: " + totalSteps, Toast.LENGTH_SHORT).show();
    ...
    private void fitHandleFailedConnection(ConnectionResult result) {
        ...
        if (!result.hasResolution()) {
            ...
            GoogleApiAvailability.getInstance().getErrorDialog(GoogleFitActivity.this, result.getErrorCode(),  0).show();
            return;
        }
        ...
        if (!authInProgress) {
            if (result.getErrorCode() == FitnessStatusCodes.NEEDS_OAUTH_PERMISSIONS) {
                try {
                    ...
                    result.startResolutionForResult(GoogleFitActivity.this, REQUEST_OAUTH);
                } catch (IntentSender.SendIntentException e) {
